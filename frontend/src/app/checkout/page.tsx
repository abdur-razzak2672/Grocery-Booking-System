...
export default function CheckoutPage() {
  ...
  }, [isAuthenticated, items, router, success]);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-4">
            <motion.div 
              ...
              className="card p-8 sticky top-[120px]"
            >
              ...
              <div className="space-y-3 pt-6 border-t border-slate-100">
                ...
                <button 
                  ...
                  className="w-full btn-primary py-4 rounded-2xl text-lg font-bold shadow-xl shadow-primary/20 disabled:opacity-50 group"
                >
                  {loading ? (
